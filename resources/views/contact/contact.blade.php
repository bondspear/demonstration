      ...
      <div class="container">
        <div class="row">
          <div class="span12">
            ...
            <form action="{{ route('sender') }}" method="post" role="form" class="contactForm">
            @csrf
              ...
              <div class="row">
                <div class="span4 form-group">
                  <input type="text" name="name" class="form-control" id="name" value="{{ Auth::User()->name }}" placeholder="Your Name" data-rule="minlen:4" data-msg="Please enter at least 4 chars" />
