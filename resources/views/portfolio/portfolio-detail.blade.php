        ...
        <div class="row">
          ...
          <div class="span8">
            <ul class="breadcrumb">
              ...
              <li><a href="portfolio-detail">Portfolio</a><i class="icon-angle-right"></i></li>
            ...
            <article>
              <div class="top-wrapper">
                ...
                <div class="flexslider">
                  <ul class="slides">
                    <li>
                      <img src="{{ asset('Flattern/img/works/full/image-01-full.jpg') }}" alt="" />
                    </li>
                    <li>
                      <img src="{{ asset('Flattern/img/works/full/image-02-full.jpg') }}" alt="" />
                    </li>
                    <li>
                      <img src="{{ asset('Flattern/img/works/full/image-03-full.jpg') }}" alt="" />
                    </li>
                  </ul>
                </div>
                <!-- end flexslider -->
